...
import { addWalletByKey } from '@wallet/scripts/apiActions'
import {
    ButtonGenerateNewWallet,
    ButtonRestoreWalletFromSeed,
    ButtonWalletAdd, ButtonBack,
} from '@wallet/components/form-elements/Buttons'
import RestoreWallet from '@wallet/components/wallet-add/restore/RestoreWallet'
import GenerateWallet from '@wallet/components/wallet-add/generate/GenerateWallet'
import { getNextWalletName, checkWalletName } from '@wallet/scripts/utils'
import { BlockTitle, WalletInfo } from '@wallet/components/form-elements/Blocks'
import { MessagesBlock } from '@wallet/components/form-elements/Messages'
