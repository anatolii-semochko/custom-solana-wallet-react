...
import { ButtonWalletAdd, ButtonListActions, ButtonBack } from '@wallet/components/form-elements/Buttons'
import AddWallet from '@wallet/components/wallet-add/AddWallet'
import WalletActions from '@wallet/components/wallets-list/wallet-actions/WalletActions'
            ...
            <div className="table-responsive mb-3">
                <table className="table table-hover align-middle mb-0">
                    <thead>
                        <tr>
                            <th>{t('wallet')}</th>
                            <th className="text-end"><span className="fst-italic mx-1">{t('currencySEV')}</span></th>
